...
<head>
    ...
    <title>دسته‌بندی: کنکور | وبلاگ آموزشی فامو</title>
    <meta name="description" content="پست‌های کنکور آموزشی فامو">

    <!-- Open Graph for Social Sharing -->
    <meta property="og:title" content="دسته‌بندی: کنکور | وبلاگ آموزشی فامو">
    <meta property="og:description" content="پست‌های کنکور آموزشی فامو">
        ...
        <div id="mobileMenu" class="hidden lg:hidden mt-4 pt-4 border-t border-white/20 animate-fade-in-up">
            <ul class="flex flex-col space-y-4">
                ...
                <li><a href="pages/courses.php"
                        class="block text-white hover:text-[#E2D9C6] transition duration-300 font-medium py-2 hover:bg-white/10 px-3rounded-lg">دوره‌ها</a></li>
...
<section class="py-24 px-4">
    <div class="container mx-auto max-w-6xl">
        <div class="mb-8">
            <h2 class="text-2xl sm:text-3xl font-bold text-[#445D84] mb-4">دسته‌بندی: کنکور</h2>
            <p class="text-gray-600">پست‌های مرتبط با کنکور و آمادگی دانشگاهی</p>
        </div>
        ...
        <div id="postsContainer" class=""></div>
